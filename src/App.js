...
fcl.config({
  ...
  "app.detail.title": "Vikings", // Change the title!
...
function App() {
  ...
  const RenderGif = () => {
    const gifUrl = user?.addr
      ? "https://64.media.tumblr.com/832332a17d1cbabb054e7cc5f44cc264/tumblr_ntss718B5Z1tdy0nco1_500.gifv"
    ...
    try {
      const transactionId = await fcl.mutate({
        ...
        args: (arg, t) => [
          ...
          arg("Vikings # " + _id.toString(), types.String),
          arg("Vikings Game Character NFTs", types.String),
          arg(
            "ipfs://bafybeies5mpmumta7xmfvfd6rxxa53ehnhrxsa5kdra5huiep7beayh6he/" +
              _id +
              ".png",
            types.String
          ),
      ...
      <div className="container">
        <div className="header-container">
          <div className="logo-container">
            ...
            <p className="header">Viking NFTs on Flow ✨</p>
          </div>
          <RenderGif />
